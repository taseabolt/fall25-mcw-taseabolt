...
The only special customization that I made was to the dataset. I isolated the total number of personnel from each brach & for each year. Then I utilized PowerQuery to transform the data into long format so that I could easily create a chart within Tableau. 
